...
## Model param
parser = argparse.ArgumentParser(description="PyTorch Snapshot Compressive Imaging")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        checkpoint = torch.load("./Checkpoint_pretrain/model_%1dstg.pkl" % opt.stage)
        ...
        print("test Avg PSNR = %.4f, train Avg PSNR = %.4f" % (psnr_total / (step + 1), checkpoint['psnr']))
